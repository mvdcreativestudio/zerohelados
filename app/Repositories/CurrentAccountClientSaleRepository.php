...
class CurrentAccountClientSaleRepository
{
    /**
    ...
    public function getAllCurrentAccounts(): array
    {
        ...
        $currentAccounts = CurrentAccount::with(['client', 'supplier', 'currency', 'payments'])->where('transaction_type', TransactionTypeEnum::SALE)->get();

        $totalAmount = $currentAccounts->sum('total_debit');

        $paidAccounts = CurrentAccount::where('status', StatusPaymentEnum::PAID)->where('transaction_type', TransactionTypeEnum::SALE)->count();

        $partialAccounts = CurrentAccount::where('status', StatusPaymentEnum::PARTIAL)->where('transaction_type', TransactionTypeEnum::SALE)->count();

        $unpaidAccounts = CurrentAccount::where('status', StatusPaymentEnum::UNPAID)->where('transaction_type', TransactionTypeEnum::SALE)->count();
    ...
    {
        $query = CurrentAccount::with(['client', 'currency'])
            ->select([
                'current_accounts.id',
            ...
            ->where('current_accounts.transaction_type', TransactionTypeEnum::SALE);
    ...
    {
        return CurrentAccountSettings::where('transaction_type', TransactionTypeEnum::SALE)->get();
    }

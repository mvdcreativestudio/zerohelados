...
class CheckoutController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('content.e-commerce.front.checkout', compact('order', 'cart', 'subtotal', 'totalPedido', 'preferenceId', 'discount', 'settings', 'googleMapsApiKey'));
  }
  ...
  public function store(Request $request)
  {
      try {
          ...
          $costoEnvio = $validatedData['shipping_cost'];
          ...
          $orderData = [
              ...
              'coupon_amount' => 0, // HARDCODEADO CAMBIAR !!! CAMBIAR !!!!!
              'discount' => 0, // HARDCODEADO CAMBIAR !!! CAMBIAR !!!!!

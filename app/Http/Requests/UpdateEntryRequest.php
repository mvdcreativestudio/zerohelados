...
class UpdateEntryRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'details.*.id' => ['nullable', 'sometimes', 'exists:entry_details,id'],
    ...
    public function messages(): array
    {
        return [
            ...
            'details.*.amount_debit.required_without' => 'El monto del Debe o Haber es obligatorio.',
            'details.*.amount_debit.numeric' => 'El monto del Debe o Haber debe ser un número.',
            'details.*.amount_debit.min' => 'El monto del Debe o Haber no puede ser negativo.',
            'details.*.amount_credit.required_without' => 'El monto del Debe o Haber es obligatorio.',
            'details.*.amount_credit.numeric' => 'El monto del Debe o Haber debe ser un número.',
            'details.*.amount_credit.min' => 'El monto del Debe o Haber no puede ser negativo.',
        ];
    }
}

$(document).ready(function () {
  ...
  function loadPosResponses() {
    $.ajax({
        ...
        success: function (response) {
            ...
            console.log('API Response:', response); // Inspect this log to verify data consistency
  ...
  function enviarTransaccionPos(token) {
    console.log('Token usado para enviar la transacción:', token);  // Mostrar el token usado
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (transactionId && sTransactionId) {
                console.log('Transacción enviada correctamente, consultando estado...');

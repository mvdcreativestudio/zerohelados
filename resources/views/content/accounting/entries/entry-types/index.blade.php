...
@section('title', 'Tipos de Asientos Contables')
...
@section('page-script')
@vite([
    'resources/assets/js/entries/entries-types/app-entries-types-list.js',
    'resources/assets/js/entries/entries-types/app-entries-types-add.js',
    'resources/assets/js/entries/entries-types/app-entries-types-edit.js',
    'resources/assets/js/entries/entries-types/app-entries-types-delete.js',
])
@endsection

@section('content')
<h4 class="py-3 mb-4">
    <span class="text-muted fw-light">Contabilidad /</span> Tipos de Asientos Contables
</h4>
        ...
        <div class="row gy-4 gy-sm-1">
            <div class="col-sm-6 col-lg-3">
                <div class="d-flex justify-content-between align-items-start card-widget-2 border-end pb-3 pb-sm-0">
                    <div>
                        <h6 class="mb-2">Total Tipos de Asientos</h6>
                        <h4 class="mb-2">{{ $entryTypes->count() }}</h4>
                    </div>
...
<!-- Entry Types List Table -->
<div class="card">
    <div class="card pb-3">
        <h5 class="card-header pb-0">
            Tipos de Asientos Contables
            <button type="button" class="btn btn-primary float-end" data-bs-toggle="modal" data-bs-target="#addEntryTypeModal">
    ...
    <div class="card-datatable table-responsive pt-0">
        ...
        <table class="table datatables-entry-types">
            <thead>
                <tr>
                    <th>
        ...
        <div class="text-center py-5">
            <h4>No hay tipos de asientos</h4>
            <p class="text-muted">Agrega un nuevo tipo de asiento para comenzar</p>
        </div>
        @endif
    </div>
</div>

@include('content.accounting.entries.entry-types.add-entry-type')
@include('content.accounting.entries.entry-types.edit-entry-type')
{{-- 
@include('content.accounting.entry-types.add-entry-type')

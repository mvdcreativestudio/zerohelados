...
<script>
  window.baseUrl = "{{ url('/') }}";
  window.detailUrl = "{{ route('incomes-suppliers.show', ':id') }}";
</script>
@endsection

@section('page-script')
@vite([
'resources/assets/js/incomes/incomes-suppliers/app-incomes-suppliers-list.js',
'resources/assets/js/incomes/incomes-suppliers/app-incomes-suppliers-add.js',
'resources/assets/js/incomes/incomes-suppliers/app-incomes-suppliers-edit.js',
'resources/assets/js/incomes/incomes-suppliers/app-incomes-suppliers-delete.js',
])
@endsection

@section('content')
<h4 class="py-3 mb-4">
  <span class="text-muted fw-light">Contabilidad /</span> Ingresos Proveedores
</h4>
    ...
    <div class="row gy-4 gy-sm-1">
      ...
      <div class="col-sm-6 col-lg-3">
        <div class="d-flex justify-content-between align-items-start">
          <div>
            <h6 class="mb-2">Ingresos Totales Proveedores</h6>
...
<div class="card">
  <div class="card pb-3">
    <h5 class="card-header pb-0">
      Ingresos
      <button type="button" class="btn btn-primary float-end" data-bs-toggle="modal" data-bs-target="#addIncomeSupplierModal">
        Agregar Ingreso
      </button>
      <div class="d-flex">
  ...
  <div class="card-datatable table-responsive pt-0">
    @if($incomes->count() > 0)
    <table class="table datatables-incomes-suppliers" data-symbol="{{ $settings->currency_symbol }}">
      <thead>
        <tr>
          <th>
    ...
    <div class="text-center py-5">
      <h4>No hay ingresos de Proveedores</h4>
...
@include('content.accounting.incomes.incomes-suppliers.add-income-supplier')
@include('content.accounting.incomes.incomes-suppliers.edit-income-supplier')
@endsection

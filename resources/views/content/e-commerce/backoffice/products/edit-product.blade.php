      ...
      <div class="card mb-4">
        ...
        <div class="card-body">
          ...
          <div class="mb-3">
            ...
            <input type="number" class="form-control" id="ecommerce-product-price" placeholder="Precio" name="old_price" value="{{$product->old_price}}" aria-label="Product price">
          </div>
          <!-- Discounted Price -->
          <div class="mb-3">
          ...
          <div class="d-flex justify-content-between align-items-center border-top pt-3">
            ...
            <div class="w-25 d-flex justify-content-end">
              <label class="switch switch-primary switch-sm me-4 pe-2">
                <input type="checkbox" class="switch-input" id="statusSwitch" {{ $product->status == 1 ? 'checked' : '' }} name="status" value="{{ $product->status }}">

  ...
  <div class="row">
    ...
    <div class="col-12 col-md-8">
      <div class="row d-flex search-bar-section align-items-center p-3 mb-4">
          ...
          <div class="btn-group w-100">
            ...
            <div class="dropdown-menu dropdown-menu-end w-100">
              <form class="p-4" onsubmit="return false">
                ...
                <div class="mb-3">
                  <label for="categorySearchInput" class="form-label">
        ...
        <div class="col-12 col-md-4 d-flex justify-content-end mb-3 mb-md-0">
          ...
          <button id="toggle-view-btn" class="btn btn-light w-100" data-bs-toggle="tooltip" data-bs-offset="0,4"
            data-bs-placement="left" data-bs-html="true" title="<span>Ver productos en lista</span>">
    ...
    <div class="col-md-4">
      <div id="cart" class="card shadow-sm p-3">
        <div class="text-end">
          <button class="btn btn-primary btn-sm" data-bs-toggle="offcanvas" data-bs-target="#offcanvasEnd"
            aria-controls="offcanvasEnd">Seleccionar cliente</button>
        </div>
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasEnd" aria-labelledby="offcanvasEndLabel">
          ...
          <div class="offcanvas-body my-auto mx-0 flex-grow-0">
            ...
            <button type="button" class="btn btn-primary mb-2 d-grid w-100" data-bs-toggle="offcanvas"
              data-bs-target="#crearClienteOffcanvas">Crear Cliente</button>

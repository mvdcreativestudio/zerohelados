...
# Variables
APP_NAME = php_zerohelados
NGINX = nginx_zerohelados
# MYSQL = mysql_zerohelados
# PHP_MY_ADMIN = phpmyadmin_zerohelados
# Desarrollo
dev_install:
...
dev_setup:
	...
	# docker exec $(APP_NAME) /bin/sh -c "wait-for-it.sh mysql_zerohelados 3306 echo 'MySQL is up'"
